    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="bg-white px-10 py-6 rounded-lg shadow-md md:w-1/2 w-5/6 flex flex-col justify-center">
        ...
        <div className="flex justify-end gap-[1em] py-2">
          <button type="button" onClick={props.onCLick} className="bg-white rounded-lg border border-gray-300 px-5 py-2 font-[500]">
            Cancel
          </button>
          <button type="button" className="bg-black px-5 py-2 font-[500] text-white rounded-lg">
            Continue
          </button>
        </div>
      </div>
