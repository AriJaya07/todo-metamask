...
export default function Form(props: { onCLick(): void }): JSX.Element {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-row border border-gray-300 bg-[#F4F4F5] p-1">
        <button
          type="button"
      ...
      <div className="flex flex-row gap-[1em] w-full py-5">
        ...
        <div className="w-1/5">
          <button
            type="button"
            className="text-[1em] font-[500] bg-gray-400 px-5 py-3 text-white w-full rounded-lg"
          >
            Add Task
          </button>
        </div>
